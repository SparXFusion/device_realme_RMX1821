...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/xml/compatibility_matrix.xml:system/vendor/compatibility_matrix.xml \
    $(LOCAL_PATH)/xml/framework_compatibility_matrix.xml:system/vendor/framework_compatibility_matrix.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/init.aee.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.aee.rc \
